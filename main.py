...
if choice == choice1:
      ...
      subprocess.run(f"sh /home/kali/Documents/Ghost/main.sh {domain} 1", shell=True)

      # Nmap
      print(Fore.CYAN + "Running Nmap...\n" + Fore.WHITE)
      subprocess.run(f"sh /home/kali/Documents/Ghost/nmap.sh {domain}", shell=True)
...
if choice == choice2:
      ...
      subprocess.run(f"sh /home/kali/Documents/Ghost/sherlock.sh {user}", shell=True)
...
if choice == choice3:
      ...
      #IP info
      subprocess.run(f"sh /home/kali/Documents/Ghost/ip_lookup.sh {ip}", shell=True)
...
if choice == choice4:
      ...
      #IP info
      subprocess.run(f"sh /home/kali/Documents/Ghost/email_info.sh {email}", shell=True)
